...
class Field:
    ...
    def G(self, x, u):
        ...
        matrix=np.zeros((3,3))
        matrix[0][0]=1
        matrix[0][2]=-trans*sin(prev_theta+ rot1)
        matrix[1][1]=1
        matrix[1][2]=trans*cos(prev_theta+ rot1)
        matrix[2][2]=1
    ...
    def V(self, x, u):
        ...
        # YOUR IMPLEMENTATION HERE
        V_m=np.zeros((3,3))
        V_m[0][0]=-trans*sin(prev_theta+rot1)
        V_m[0][1]=sin(prev_theta+ rot1)
        V_m[1][0]=trans*cos(prev_theta+rot1)
        V_m[1][1]=cos(prev_theta+ rot1)
        V_m[2][0]=1
        V_m[2][2]=1
    ...
    def H(self, x, marker_id):
        ...
        prev_x, prev_y, prev_theta = x.ravel()
        # YOUR IMPLEMENTATION HERE
        #H=tan-1((Y-prev_y)/(X-prev_x))-prev_theta
